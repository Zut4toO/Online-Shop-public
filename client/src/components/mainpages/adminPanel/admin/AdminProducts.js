...
import CreateCategories from '../adminComponents/CreateCategories';
import {
  Accordion,
  AccordionItem,
  AccordionButton,
...
import ToppingExtra from '../adminComponents/ToppingExtra';
import ToppingRemove from '../adminComponents/ToppingRemove';
import AddAdditive from '../adminComponents/AddAdditive';
  ...
  return (
    <div className='min-h-screen bg-gray-800 2xl:grid 2xl:grid-cols-7 2xl:gap-4'>
          ...
          <ul className='mx-2'>
            ...
            {isAdmin || isMasterAdmin ? (
              <li class='relative mb-1'>
                <Link
                  to='/settings'
                  class='flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-700 transition duration-300 ease-in-out'
                >
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    className={`h-5 w-5 mr-2 ${text}`}
      ...
      <div className={'2xl:hidden' + (sidenav ? '' : ' hidden')}>
        <ul className='shadow-xl bg-gray-900 px-1 absolute relative pb-2'>
          ...
          {isAdmin || isMasterAdmin ? (
            <li class='relative mb-1'>
              <Link
                class='flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded bg-gray-700 hover:bg-gray-700 transition duration-300 ease-in-out'
                to='/products'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
      ...
      <div className='2xl:col-span-6 2xl:ml-4 2xl:bg-gray-800 bg-gray-900'>
        ...
        <div className='grid grid-cols-12 text-gray-100 pb-8 2xl:bg-gray-900 px-4 pt-4'>
          <div className={`xl:col-span-4 col-span-12 ${border} mb-2 xl:pr-20`}>
            <h2
            ...
            <Accordion allowToggle>
              <AccordionItem>
                <div
                  className={`py-3 px-4 bg-gray-600 text-xl border-b-2 ${border}`}
                >
                  <AccordionButton>
                    <div className='mx-auto'>Kategorie hinzufügen</div>
                  </AccordionButton>
                </div>
              ...
              <AccordionItem>
                ...
                >
                  <AccordionButton>
                    <div className='mx-auto'>Extras hinzufügen</div>
                  </AccordionButton>
                </div>
              ...
              <AccordionItem>
                ...
                >
                  <AccordionButton>
                    <div className='mx-auto'>Abwahl hinzufügen</div>
                  </AccordionButton>
                </div>
              ...
              <AccordionItem>
                ...
                >
                  <AccordionButton>
                    <div className='mx-auto'>Zusatzstoffe hinzufügen</div>
                  </AccordionButton>
                </div>
          ...
          <div className={`xl:col-span-5 col-span-12  ${border} mb-2`}>
            {<ProductList />}
          </div>
