...
import YearlyOrders from '../adminComponents/YearlyOrders';
import SystemSettings from '../adminComponents/SystemSettings';
import Subscription from '../adminComponents/Subscription';
    ...
    <div className='min-h-screen bg-gray-800 2xl:grid 2xl:grid-cols-7 2xl:gap-4'>
      ...
      <div className='2xl:col-span-6 2xl:ml-4 2xl:bg-gray-800 bg-gray-900'>
        ...
        <div className='grid grid-cols-12 '>
          <div
            className={`2xl:col-span-4 col-span-12 2xl:border-r ${border} 2xl:border-b-0 border-b mb-2`}
          >
            <Subscription />
          </div>
          <div
          ...
          <div className='2xl:col-span-4 col-span-12 mb-2'>
            <SystemSettings />
          </div>
        </div>
      </div>
