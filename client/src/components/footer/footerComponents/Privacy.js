          ...
          <div class='w-full'>
            <div className=' bg-gray-800 p-6 rounded shadow-2xl '>
              ...
              <div className='text-white font-semibold pl-4 pt-4'>
                <h2 className={`font-bold text-xl ${text}`}>
                  1. Datenschutz auf einen Blick
                </h2>
                <h3 className='text-semibold text-lg'>Allgemeine Hinweise</h3>{' '}
                <p>
                ...
                <h2 className={`font-bold text-xl ${text}`}>2. Hosting</h2>
                <h3 className='text-semibold text-lg'>Externes Hosting</h3>{' '}
                <p>
                ...
                <p>
                  ...
                  <br />
                  CYP-6023 Larnaca, Zypern
                </p>
                <h2 className={`font-bold text-xl ${text}`}>
                  3. Allgemeine Hinweise und Pflicht&shy;informationen
                </h2>
                <h3 className='text-semibold text-lg'>Datenschutz</h3>{' '}
                <p>
                ...
                <p>
                  <div>Telefon: {settings[0]?.telefon}</div>
                  <div>E-Mail: {settings[0]?.email}</div>
                </p>
                <p>
                ...
                <h3 className='text-semibold text-lg'>Speicherdauer</h3>{' '}
                <p>
                ...
                <h3 className='text-semibold text-lg'>Cookies</h3>{' '}
                <p>
                ...
                <h3 className='text-semibold text-lg'>YouTube</h3>{' '}
                <p>
                ...
                <p>
                  ...
                  DSGVO dar. Sofern eine entsprechende Einwilligung abgefragt
